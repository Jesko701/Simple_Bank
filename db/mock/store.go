...
// Source: solo_simple-bank_tutorial/db/sqlc (interfaces: Store)
...
import (
	context "context"
	reflect "reflect"
	sqlc "solo_simple-bank_tutorial/db/sqlc"
...
func (m *MockStore) CreateEntries(arg0 context.Context, arg1 sqlc.CreateEntriesParams) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
...
// DeleteAccountDB mocks base method.
func (m *MockStore) DeleteAccountDB(arg0 context.Context, arg1 int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAccountDB", arg0, arg1)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DeleteAccountDB indicates an expected call of DeleteAccountDB.
func (mr *MockStoreMockRecorder) DeleteAccountDB(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAccountDB", reflect.TypeOf((*MockStore)(nil).DeleteAccountDB), arg0, arg1)
}
...
func (m *MockStore) GetEntries(arg0 context.Context, arg1 int64) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
